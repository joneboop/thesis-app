...
const form = useForm({
  ...
  rank: props.tier.rank,
  min_spend: props.tier.min_spend,
  is_active: !!props.tier.is_active,
})

const save = () => form.put(route('membership.tiers.update', props.tier.id))
</script>

<template>
  <AppLayout>
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-semibold">Edit Tier</h1>
